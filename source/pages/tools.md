...
<h4><a href="javascript:(()=>{location='https://go.openathens.net/redirector/auckland.ac.nz?url='+encodeURI(location.href)})()"> UoA 🔑</a></h4>
...
<h4><a href="javascript:(()=>{location='https://login.helicon.vuw.ac.nz/login?url='+encodeURI(location.href)})()"> VUW 🔑</a></h4>
...
<h4><a href="javascript:(()=>{location=('https://annas-archive.org/scidb/'+location.href+'\n'+document.body.innerText).match(/\b10.\d{4,9}\/[-._;()\/:A-Z0-9]+/gi)[0]})()"> Annas 🔑</a></h4>
