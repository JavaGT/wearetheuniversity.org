...
"The Council of Trade Unions will today be [surveying](http://www.together.org.nz/level-3-survey) those who went back to the work site today about whether the [’10 checks for a safe return to work’](http://www.together.org.nz/stay_safe_at_level_3) have been followed. Alert Level 3 is no return to ‘business as usual’ for health and safety. Let the Level 3 re-opening be the reset button we need to treat every workplace risk with the same level of caution we will for COVID-19 - there is no reason any Kiwi should be killed at work," Wagstaff said.
