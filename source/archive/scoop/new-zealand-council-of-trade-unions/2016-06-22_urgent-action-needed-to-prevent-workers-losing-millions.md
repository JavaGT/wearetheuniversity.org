...
“Currently, there is a six year time limit on when employers must keep pay records. If, for example, it takes us two years to fix these issues, that’s two years of money owed to working people that may never be paid.

“We know what the solution is and have drafted a [law change](http://union.org.nz/sites/union.org.nz/files/CTU-Holiday-Leave-Protection-Bill-20160620.pdf) that will fix the problem and give some breathing space to the government, employers, and unions while the bigger payroll problems are sorted out. We are confident the government will find the numbers in the house to pass it urgently.”
...
“We have provided the Government with the opportunity to take this first important step, and we will support them in every way we can to help them achieve it for all working New Zealanders,” Huggard said.

Document providing background information can be found [here](http://union.org.nz/sites/union.org.nz/files/CTU-Holiday-Back-Pay-Background-Info.pdf).
