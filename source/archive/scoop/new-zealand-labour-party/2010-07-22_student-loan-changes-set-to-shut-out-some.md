...
"It is even more ridiculous when the policy itself is, according to Treasury ‘_creates unnecessary complexity in the system for little gain_’. Papers released under the Official Information Act indicate that the policy will cost more to administer than it will save for many years. And even when fully implemented, it will only affect 250 people a year and save a few hundred thousand dollars.
