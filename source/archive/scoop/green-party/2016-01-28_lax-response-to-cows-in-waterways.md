...
**Thursday, 28 January 2016, 11:36 am**  
...
The comments come on the back of the most recent [Environment Canterbury (ECan) compliance report](http://ecan.govt.nz/publications/Plans/compliance-monitoring-annual-report-april-2015.pdf) which shows 95 complaints were made to the council about stock entering waterways in 2013 and 2014, with only one resulting in a fine. ECan records also show that it failed to do anything [the first time it was alerted](http://www.stuff.co.nz/the-press/opinion/76288818/editorial-environment-canterbury-should-be-doing-more-to-protect-lakes-from-cattle) to the problem of cattle entering waterways on Lake Station.
