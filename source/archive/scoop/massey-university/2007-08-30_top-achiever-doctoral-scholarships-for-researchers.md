...
With the fast-paced development of technology, Organic Computing has recently emerged as a challenging vision for future information processing systems.
...
In addition a collaborative research project, _Organic computing and adaptive learning technologies in a Multicultural Context_ between the School of Curriculum and Pedagogy at Massey University and a research England is proposed using the research findings from this project as the basic design principles to create the prototype of an online learning system; thereby building links between researchers in New Zealand and Britain.
