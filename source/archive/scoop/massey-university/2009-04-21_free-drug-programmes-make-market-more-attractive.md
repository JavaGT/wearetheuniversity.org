...
In their paper, _Hopping on the Methadone Bus_, Dr Lippert and Dr Schumacher have devised a model in which dealers use payment and punishment options to screen between high and low-risk users. If the user doesn’t pay, it assumes the dealer requires the user to deal or smuggle drugs to repay their debt.
...
Low-risk users also try to regulate their drug consumption according to what they can afford or try to increase their legitimate income.
...
Their findings will be published in the _Journal of Health Economics_ later this year.
