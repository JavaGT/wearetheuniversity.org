...
Professor Spoonley is one of many interviewed for the series, which covers the following topics:  
Have You Come Far? (history and context); Borderline (tensions); Theory and Practice (how immigration works); Choices (where to from here), with an epilogue in the form of an immigration panel at Auckland Museum in August.  
   
