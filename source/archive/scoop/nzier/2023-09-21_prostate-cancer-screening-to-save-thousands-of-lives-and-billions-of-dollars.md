...
**Thursday, 21 September 2023, 10:36 am**  
**Press Release: [NZIER](https://info.scoop.co.nz/NZIER)**

Introducing a nationwide screening programme for prostate cancer could save thousands of lives and generate billions of dollars in health gains over the next generation, according to modelling conducted by the New Zealand Institute of Economic Research (NZIER) for the Prostate Cancer Foundation New Zealand.
...
Cancer kills. Early detection of cancer reduces the number of people who die from it. Whatever the circumstance, there are always better clinical outcomes if the existence of cancer is known earlier. New Zealand agrees with this and currently takes action on some cancers, though not prostate cancer. For example, every year:
