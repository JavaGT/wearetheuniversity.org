...
**Thursday, 8 August 2013, 1:02 pm**  
...
A University of Canterbury (UC) postgraduate student is using digital media to help people with dementia to improve their quality and quantity of communication.
...
\`\`Dementia is an age-related disease where likelihood increases with age from approximately one in 100 people over the age of 65 and one in four over the age of 80.

\`\`In New Zealand the number of people diagnosed with a dementia is expected to increase from one percent of the population in 2008 to 1.5 percent of the population by 2026. Alzheimer’s disease accounts for up to 70 percent of all dementias.
...
\`\`I wanted to determine whether a dedicated speech-language therapist based in the community provided greater access to speech-language therapy services for older people diagnosed with a dementia or mental health disorder.
...
\`\`This set up is now in place and is the first position of its kind in New Zealand. Older adults with a mental health disorder or dementia referred for speech-language therapy intervention are usually seen by community speech-language therapists and are subject to community waitlists.
