...
**Monday, 12 February 2018, 2:33 pm**  
...
The UC Neuromorphic Computer Chip uses a network of nanoparticles to emulate neuromorphic processing directly in hardware – a radically different approach to the experimental neuromorphic chips currently available.
...
Neuromorphic computing is also used for deep learning applications, which include computer vision, natural language processing, data mining and artificial intelligence.

Conventional computers can implement neuromorphic computing in software, however the last few years have seen the arrival of neuromorphic chips – specialised silicon chips that implement neuromorphic computing primarily in hardware rather than software.
