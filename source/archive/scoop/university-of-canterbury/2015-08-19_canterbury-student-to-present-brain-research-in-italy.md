...
**Wednesday, 19 August 2015, 8:20 am**  
...
Sudhanshu says the research enables a new type of system comprising multiple modules not previously available on any brain computer interface (BCI) devices. The current _Elapse_ configuration has been developed to provide a common hardware and software platform to aid research in the fields of cognitive monitoring, particularly microsleep detection.

The _Elapse_ system uses novel machine learning algorithms to maximally acquire new cues for detecting microsleeps from deep neuro-electric activity in the brain and changes in neural connectivity.
