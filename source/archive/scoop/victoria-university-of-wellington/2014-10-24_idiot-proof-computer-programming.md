...
**Friday, 24 October 2014, 12:53 pm**  
...
“Currently these different languages are designed without taking into account that the others exist, so you write a programme and you only find out there’s an error when you try to run it and it doesn’t work.

“We’re bridging this gap by combining this mish-mash into a single underlying language that is easy to use. Our design means on one hand you are writing in a language that is comfortable to you but underneath it translates to the core single language that is checked for errors.”
