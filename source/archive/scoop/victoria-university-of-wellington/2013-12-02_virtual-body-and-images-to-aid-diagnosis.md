...
According to Dr Jinman Kim, theme leader in the Institute of Biomedical and Multimedia Information Technology (BMIT), medical imaging is now a fundamental aspect of healthcare delivery but the challenge facing clinicians is how best to extract or identify relevant information from these massive data sets.
...
“These data come from a variety of imaging scanners used to acquire images of the human body, such as dual-modal positron emission tomography and computed tomography (PET-CTs), ultrasound, and magnetic resonance imaging (MRIs), “explains Dr Kim.
