...
Aaron plans to use the Faculty of Engineering’s new Mobile Field Laboratory to simulate an earthquake on an actual un-reinforced masonry building, using a machine called a shaker.
