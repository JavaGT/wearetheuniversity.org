...
**Saturday, 28 March 2020, 11:48 am**  
...
**Note to editors: Confirmation that the full subsidy amount must be paid to all workers can be found** [**here**](https://www.workandincome.govt.nz/online-services/covid-19/declaration-wage-subsidy.html)**. Confirmation that the subsidy has to be paid out for multiple part-time jobs can be found** [**here**](https://workandincome.govt.nz/products/a-z-benefits/employer-questions-and-answers.html#null) **under the ‘multiple applications’ section.**
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
