...
export class Game {
    ...
    draw() {
        ...
        if (this.aliens.flat().length === 0) {
            ...
            this.ctx.fillText('Congraulations for meeting your KPIs,', this.canvas.width / 2, this.canvas.height / 2 + 50);
            this.ctx.fillText(' please refresh the page to move on to the next university.', this.canvas.width / 2, this.canvas.height / 2 + 70);
        }
